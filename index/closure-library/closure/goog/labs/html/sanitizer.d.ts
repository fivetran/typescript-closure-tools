...
declare module goog.labs.html {
    ...
    class Sanitizer {
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: string) => string): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: string) => goog.html.SafeHtml): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: string) => goog.html.SafeStyle): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: string) => goog.html.SafeUrl): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeHtml) => string): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeHtml) => goog.html.SafeHtml): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeHtml) => goog.html.SafeStyle): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeHtml) => goog.html.SafeUrl): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeStyle) => string): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeStyle) => goog.html.SafeHtml): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeStyle) => goog.html.SafeStyle): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeStyle) => goog.html.SafeUrl): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeUrl) => string): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeUrl) => goog.html.SafeHtml): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeUrl) => goog.html.SafeStyle): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
         ...
         * @return {!goog.labs.html.Sanitizer} {@code this}.
         */
        allowAttributes(elementNames: string[], attrNames: string[], opt_rewriteValue?: (_0: goog.html.SafeUrl) => goog.html.SafeUrl): goog.labs.html.Sanitizer;
        /**
         * Allows in the sanitized output
         * <tt>&lt;<i>element</i> <i>attr</i>="..."&gt;</tt>
         * when <i>element</i> is in {@code elementNames} and
