...
declare module goog.graphics.ext.coordinates {
     ...
     */
    function isSpecial(coord: string|number|any /*null*/): boolean;
     ...
     */
    function getValue(coord: string|number, forMaximum: boolean|any /*undefined*/, containerSize: number, scale: number, opt_cache?: Object): number;
}
