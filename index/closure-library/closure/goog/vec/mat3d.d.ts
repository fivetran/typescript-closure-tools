...
declare module goog.vec.mat3d {
     ...
     *     chained together.
     */
    function setFromValues(mat: Float64Array, v00: number, v10: number, v20: number, v01: number, v11: number, v21: number, v02: number, v12: number, v22: number): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setFromMat3d(mat: Float64Array, src: Float64Array): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setFromMat3f(mat: Float64Array, src: Float32Array): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setFromArray(mat: Float64Array, src: number[]): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setElement(mat: Float64Array, row: number, column: number, value: number): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setDiagonalValues(mat: Float64Array, v00: number, v11: number, v22: number): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setDiagonal(mat: Float64Array, vec: Float64Array): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setColumnValues(mat: Float64Array, column: number, v0: number, v1: number, v2: number): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setColumn(mat: Float64Array, column: number, vec: Float64Array): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function getColumn(mat: Float64Array, column: number, vec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function setColumns(mat: Float64Array, vec0: Float64Array, vec1: Float64Array, vec2: Float64Array): goog.vec.mat3d.Type;
     ...
     */
    function getColumns(mat: Float64Array, vec0: Float64Array, vec1: Float64Array, vec2: Float64Array): void;
     ...
     *     chained together.
     */
    function setRowValues(mat: Float64Array, row: number, v0: number, v1: number, v2: number): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function setRow(mat: Float64Array, row: number, vec: Float64Array): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function getRow(mat: Float64Array, row: number, vec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function setRows(mat: Float64Array, vec0: Float64Array, vec1: Float64Array, vec2: Float64Array): goog.vec.mat3d.Type;
     ...
     */
    function getRows(mat: Float64Array, vec0: Float64Array, vec1: Float64Array, vec2: Float64Array): void;
     ...
     */
    function makeZero(mat: Float64Array): goog.vec.mat3d.Type;
     ...
     * @return {!goog.vec.mat3d.Type} return mat so operations can be chained.
     */
    function makeIdentity(mat: Float64Array): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function addMat(mat0: Float64Array, mat1: Float64Array, resultMat: Float64Array): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function subMat(mat0: Float64Array, mat1: Float64Array, resultMat: Float64Array): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function multScalar(mat: Float64Array, scalar: number, resultMat: Float64Array): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function multMat(mat0: Float64Array, mat1: Float64Array, resultMat: Float64Array): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function transpose(mat: Float64Array, resultMat: Float64Array): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function makeTranslate(mat: Float64Array, x: number, y: number): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function makeScale(mat: Float64Array, x: number, y: number, z: number): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function makeRotate(mat: Float64Array, angle: number, ax: number, ay: number, az: number): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function makeRotateX(mat: Float64Array, angle: number): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function makeRotateY(mat: Float64Array, angle: number): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function makeRotateZ(mat: Float64Array, angle: number): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function rotate(mat: Float64Array, angle: number, x: number, y: number, z: number): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function rotateX(mat: Float64Array, angle: number): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function rotateY(mat: Float64Array, angle: number): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function rotateZ(mat: Float64Array, angle: number): goog.vec.mat3d.Type;
     ...
     *     chained.
     */
    function makeEulerZXZ(mat: Float64Array, theta1: number, theta2: number, theta3: number): goog.vec.mat3d.Type;
     ...
     *     chained together.
     */
    function toEulerZXZ(mat: Float64Array, euler: Float64Array, opt_theta2IsNegative?: boolean): goog.vec.vec3d.Type;
}
