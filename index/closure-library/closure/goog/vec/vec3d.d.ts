...
declare module goog.vec.vec3d {
     ...
     *     chained together.
     */
    function setFromValues(vec: Float64Array, v0: number, v1: number, v2: number): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function setFromVec3d(vec: Float64Array, src: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function setFromVec3f(vec: Float64Array, src: Float32Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function setFromArray(vec: Float64Array, src: number[]): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function add(vec0: Float64Array, vec1: Float64Array, resultVec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function subtract(vec0: Float64Array, vec1: Float64Array, resultVec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function negate(vec0: Float64Array, resultVec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function abs(vec0: Float64Array, resultVec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function scale(vec0: Float64Array, scalar: number, resultVec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function normalize(vec0: Float64Array, resultVec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function cross(v0: Float64Array, v1: Float64Array, resultVec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function direction(vec0: Float64Array, vec1: Float64Array, resultVec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function lerp(v0: Float64Array, v1: Float64Array, f: number, resultVec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function max(vec0: Float64Array, limit: Float64Array, resultVec: Float64Array): goog.vec.vec3d.Type;
    /**
     * Compares the components of vec0 with the components of another vector or
     * scalar, storing the larger values in resultVec.
     *
     ...
     *     chained together.
     */
    function max(vec0: Float64Array, limit: number, resultVec: Float64Array): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    function min(vec0: Float64Array, limit: Float64Array, resultVec: Float64Array): goog.vec.vec3d.Type;
    /**
     * Compares the components of vec0 with the components of another vector or
     * scalar, storing the smaller values in resultVec.
     *
     ...
     *     chained together.
     */
    function min(vec0: Float64Array, limit: number, resultVec: Float64Array): goog.vec.vec3d.Type;
