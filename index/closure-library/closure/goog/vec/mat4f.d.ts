...
declare module goog.vec.mat4f {
     ...
     *     chained together.
     */
    function setFromValues(mat: Float32Array, v00: number, v10: number, v20: number, v30: number, v01: number, v11: number, v21: number, v31: number, v02: number, v12: number, v22: number, v32: number, v03: number, v13: number, v23: number, v33: number): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setFromMat4f(mat: Float32Array, src: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setFromMat4d(mat: Float32Array, src: Float64Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setFromArray(mat: Float32Array, src: number[]): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setElement(mat: Float32Array, row: number, column: number, value: number): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setDiagonalValues(mat: Float32Array, v00: number, v11: number, v22: number, v33: number): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setDiagonal(mat: Float32Array, vec: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function getDiagonal(mat: Float32Array, vec: Float32Array, opt_diagonal?: number): goog.vec.vec4f.Type;
     ...
     *     chained together.
     */
    function setColumnValues(mat: Float32Array, column: number, v0: number, v1: number, v2: number, v3: number): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setColumn(mat: Float32Array, column: number, vec: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function getColumn(mat: Float32Array, column: number, vec: Float32Array): goog.vec.vec4f.Type;
     ...
     *     chained together.
     */
    function setColumns(mat: Float32Array, vec0: Float32Array, vec1: Float32Array, vec2: Float32Array, vec3: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setRowValues(mat: Float32Array, row: number, v0: number, v1: number, v2: number, v3: number): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function setRow(mat: Float32Array, row: number, vec: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function getRow(mat: Float32Array, row: number, vec: Float32Array): goog.vec.vec4f.Type;
     ...
     *     chained together.
     */
    function setRows(mat: Float32Array, vec0: Float32Array, vec1: Float32Array, vec2: Float32Array, vec3: Float32Array): goog.vec.mat4f.Type;
     ...
     */
    function makeZero(mat: Float32Array): goog.vec.mat4f.Type;
     ...
     * @return {!goog.vec.mat4f.Type} return mat so operations can be chained.
     */
    function makeIdentity(mat: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function addMat(mat0: Float32Array, mat1: Float32Array, resultMat: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function subMat(mat0: Float32Array, mat1: Float32Array, resultMat: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function multScalar(mat: Float32Array, scalar: number, resultMat: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function multMat(mat0: Float32Array, mat1: Float32Array, resultMat: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function transpose(mat: Float32Array, resultMat: Float32Array): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function multVec3NoTranslate(mat: Float32Array, vec: Float32Array, resultVec: Float32Array): goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function multVec3Projective(mat: Float32Array, vec: Float32Array, resultVec: Float32Array): goog.vec.vec3f.Type;
     ...
     *     chained together.
     */
    function multVec4(mat: Float32Array, vec: Float32Array, resultVec: Float32Array): goog.vec.vec4f.Type;
     ...
     *     chained.
     */
    function makeTranslate(mat: Float32Array, x: number, y: number, z: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeScale(mat: Float32Array, x: number, y: number, z: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeRotate(mat: Float32Array, angle: number, ax: number, ay: number, az: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeRotateX(mat: Float32Array, angle: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeRotateY(mat: Float32Array, angle: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeRotateZ(mat: Float32Array, angle: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeFrustum(mat: Float32Array, left: number, right: number, bottom: number, top: number, near: number, far: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makePerspective(mat: Float32Array, fovy: number, aspect: number, near: number, far: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeOrtho(mat: Float32Array, left: number, right: number, bottom: number, top: number, near: number, far: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeLookAt(mat: Float32Array, eyePt: Float32Array, centerPt: Float32Array, worldUpVec: Float32Array): goog.vec.mat4f.Type;
     ...
     */
    function toLookAt(mat: Float32Array, eyePt: Float32Array, fwdVec: Float32Array, worldUpVec: Float32Array): boolean;
     ...
     *     chained.
     */
    function makeEulerZXZ(mat: Float32Array, theta1: number, theta2: number, theta3: number): goog.vec.mat4f.Type;
     ...
     *     chained together.
     */
    function toEulerZXZ(mat: Float32Array, euler: Float32Array, opt_theta2IsNegative?: boolean): goog.vec.vec4f.Type;
     ...
     *     chained.
     */
    function translate(mat: Float32Array, x: number, y: number, z: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function scale(mat: Float32Array, x: number, y: number, z: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function rotate(mat: Float32Array, angle: number, x: number, y: number, z: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function rotateX(mat: Float32Array, angle: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function rotateY(mat: Float32Array, angle: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function rotateZ(mat: Float32Array, angle: number): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function getTranslation(mat: Float32Array, translation: Float32Array): goog.vec.vec3f.Type;
}
