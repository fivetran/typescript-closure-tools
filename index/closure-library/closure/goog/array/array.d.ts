...
declare module goog.array {
     ...
     * @template T
     */
    function peek<T>(array: T[]|goog.array.ArrayLike): T;
     ...
     * @template T
     */
    function last<T>(array: T[]|goog.array.ArrayLike): T;
     ...
     * @template T
     */
    function indexOf<T>(arr: T[]|goog.array.ArrayLike, obj: T, opt_fromIndex?: number): number;
     ...
     * @template T
     */
    function lastIndexOf<T>(arr: T[]|goog.array.ArrayLike, obj: T, opt_fromIndex?: number): number;
     ...
     */
    function map<THIS, VALUE, RESULT>(arr: VALUE[]|goog.array.ArrayLike, f: { (_0: VALUE, _1: number, _2: any): RESULT }, opt_obj?: THIS): RESULT[];
     ...
     * @template T
     */
    function remove<T>(arr: T[]|goog.array.ArrayLike, obj: T): boolean;
     ...
     * @template T
     */
    function toArray<T>(object: T[]|goog.array.ArrayLike): T[];
     ...
     * @template T
     */
    function clone<T>(arr: T[]|goog.array.ArrayLike): T[];
     ...
     * @template T
     */
    function splice<T>(arr: T[]|goog.array.ArrayLike, index: number|any /*undefined*/, howMany: number, ...var_args: T[]): T[];
     ...
     * @template T
     */
    function slice<T>(arr: T[]|goog.array.ArrayLike, start: number, opt_end?: number): T[];
     ...
     * @template T
     */
    function removeDuplicates<T>(arr: T[]|goog.array.ArrayLike, opt_rv?: any[], opt_hashFn?: { (_0: T): string }): void;
     ...
     */
    function binarySearch<TARGET, VALUE>(arr: VALUE[]|goog.array.ArrayLike, target: TARGET, opt_compareFn?: { (_0: TARGET, _1: VALUE): number }): number;
     ...
     * @template THIS, VALUE
     */
    function binarySelect<THIS, VALUE>(arr: VALUE[]|goog.array.ArrayLike, evaluator: { (_0: VALUE, _1: number, _2: any): number }, opt_obj?: THIS): number;
     ...
     * @template VALUE
     */
    function compare3<VALUE>(arr1: VALUE[]|goog.array.ArrayLike, arr2: VALUE[]|goog.array.ArrayLike, opt_compareFn?: { (_0: VALUE, _1: VALUE): number }): number;
     ...
     * @template VALUE
     */
    function binaryInsert<VALUE>(array: VALUE[]|goog.array.ArrayLike, value: VALUE, opt_compareFn?: { (_0: VALUE, _1: VALUE): number }): boolean;
     ...
     * @template VALUE
     */
    function binaryRemove<VALUE>(array: VALUE[]|goog.array.ArrayLike, value: VALUE, opt_compareFn?: { (_0: VALUE, _1: VALUE): number }): boolean;
     ...
     */
    function moveItem(arr: any[]|Arguments|{ length: number }, fromIndex: number, toIndex: number): void;
