...
declare module goog.async {
    ...
    class Deferred__Class<VALUE> implements goog.Thenable<VALUE>  { 
             ...
             * @template T
             */
            addCallbacks<T>(cb: { (_0: VALUE): any }|any /*null*/, eb: { (_0: any): any }|any /*null*/, opt_scope?: T): goog.async.Deferred<any>;
             ...
             */
            then<RESULT,THIS>(opt_onFulfilled?: { (_0: any): RESULT|IThenable<RESULT>|Thenable<any> }, opt_onRejected?: { (_0: any): any }, opt_context?: THIS): goog.Promise<RESULT>;
    } 
...
declare module goog.async.Deferred {
     ...
     * @template T
     */
    function fromPromise<T>(promise: goog.Promise<T>): goog.async.Deferred<T>;
