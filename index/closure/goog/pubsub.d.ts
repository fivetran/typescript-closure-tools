// Generated Wed Apr 30 16:27:40 PDT 2014
...
declare module 'goog.pubsub' {
    ...
    class TypedPubSub extends goog.Disposable {
         ...
         */
        subscribe(topic: goog.pubsub.TopicId<PAYLOAD>, fn: (_0: PAYLOAD) => any /*missing*/, opt_context?: CONTEXT): number;
         ...
         * @template PAYLOAD, CONTEXT
         */
        subscribeOnce(topic: goog.pubsub.TopicId<PAYLOAD>, fn: (_0: PAYLOAD) => any /*missing*/, opt_context?: CONTEXT): number;
         ...
         * @template PAYLOAD, CONTEXT
         */
        unsubscribe(topic: goog.pubsub.TopicId<PAYLOAD>, fn: (_0: PAYLOAD) => any /*missing*/, opt_context?: CONTEXT): boolean;
         ...
         * @template PAYLOAD
         */
        publish(topic: goog.pubsub.TopicId<PAYLOAD>, payload: PAYLOAD): boolean;
         ...
         * @template PAYLOAD
         */
        clear(opt_topic?: goog.pubsub.TopicId<PAYLOAD>): void;
         ...
         * @template PAYLOAD
         */
        getCount(opt_topic?: goog.pubsub.TopicId<PAYLOAD>): number;
    }
}
