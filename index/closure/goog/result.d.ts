// Generated Wed Apr 30 16:40:18 PDT 2014
...
declare module 'goog.result' {
     ...
     */
    interface Result {
        wait(handler: (_0: goog.result.Result) => any /*missing*/, opt_scope?: T): void;
    ...
    class SimpleResult implements goog.result.Result {
         ...
         * @override
         */
        wait(handler: (_0: goog.result.SimpleResult) => any /*missing*/, opt_scope?: T): void;
